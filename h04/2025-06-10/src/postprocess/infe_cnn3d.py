...
# Para grandes videos, puede ser más eficiente usar un iterador de frames como cv2.VideoCapture o decodificar por chunks, pero para 10 minutos está bien.

video_path = "inference/england_epl/2016-2017/2017-05-06 - 17-00 Leicester 3 - 0 Watford/1_720p.mkv"
# Ajustar esto si cambias la duración del clip en el entrenamiento
CLIP_DURATION_SEC_INFERENCE = 10.0
...
def infer_full_video(
    ...
    """
    Realiza inferencia sobre un video completo usando un enfoque de ventana deslizante. Genera series temporales de probabilidades para cada acción.
    Args:
